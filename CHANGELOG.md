...
### Added
- `docs/CROSS-CHAIN-BRIDGE.md` README entry — cross-chain bridge hooks (SSS-135): Wormhole + LayerZero, BridgeConfig PDA, bridge_out/bridge_in instructions, FLAG_BRIDGE_ENABLED (bit 13), chain ID table, security model, deployment guide
